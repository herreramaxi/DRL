...
def register_gridworld_env():
    """Registers the GridWorld environment if not already registered."""
    if "gymnasium_env/GridWorld-v0" not in gym.envs.registry:
        gym.register(
            id="gymnasium_env/GridWorld-v0",
            entry_point="GridWorld.GridWorldEnv:GridWorldEnv",  # fully qualified path
