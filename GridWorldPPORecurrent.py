...
MODEL_PATH = "ppo_recurrent_gridworld.zip"
LOG_DIR = "./ppo_recurrent_logs"
...
if __name__ == "__main__":  # ✅ IMPORTANT for Windows multiprocessing
    ...
    if not os.path.exists(MODEL_PATH):
        ...
        model = RecurrentPPO(
            ...
            n_steps=2048,       # Lower for faster updates
        ...
        model.learn(total_timesteps=TOTAL_TIMESTEPS, tb_log_name="PPO_recurrent_GridWorld")
